...
> **Когда прогонять:** после закрытия спринтов nik-трека (N1–N5). Tier 0/1 написаны как
> исполнимая спецификация: красный тест там, где фича ещё не сделана — это чек-лист, а не
> регресс. По мере закрытия N1 (сервер) и N2 (синк/тайминг) соответствующие тесты зеленеют.
>
...
## Tier 0 — безопасность и целостность данных (обязательно)
...
## Tier 1 — корректность синка и тайминга (высокий ROI)
...
## Tier 2 — кодеки/форматы (по желанию)
